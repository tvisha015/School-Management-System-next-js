...
const Navbar = async () => {
  ...
  return (  
    <div className='flex items-center justify-between gap-4'>
      {/* search bar */}
      <div className='hidden md:flex items-center gap-3 text-xs rounded-full ring-[1.5px] ring-gray-300 px-2 ml-2'>
        <Image src="/search.png" alt='search icon' width={18} height={14}/>
        <input type="text" placeholder='Search...' className='w-[200px] p-2 bg-transparent outline-none'/>
      </div>
      {/* menu and user */}
      <div className='flex items-center gap-6 mt-2.5 justify-end w-full'>
